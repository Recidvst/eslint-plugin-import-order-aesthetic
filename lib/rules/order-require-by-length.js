  ...
  create: function (context) {
    ...
    return {
      ...
      VariableDeclaration: function (node) {
        ...
        if (node.range.length && declaration && declaration.init && declaration.init.callee && declaration.init.callee.name === 'require') {
      ...
      onCodePathEnd: function (codePath, node) {
        ...
        if (statementArr.length > 0 && sortedArr.length > 0) {
          ...
          if (
            ENV === 'testing' && sourceCode.getText(statementArr[0].node) === "const lengthtest = require('break-test');"
          ) {
          ...
          if ( ENV === 'testing' && sourceCode.getText(statementArr[0].node) === "const nulltest = require('break-test');") {
            statementArr = null;
          }
